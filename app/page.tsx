    ...
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-950 dark:to-gray-900">
      ...
      <section id="projects" className="pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="https://github.com/houssem98/AlphaGravity" target="_blank" rel="noopener noreferrer" className="group p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg hover:border-blue-400 transition">
              <h3 className="text-xl font-semibold mb-2 group-hover:text-blue-600">AlphaGravity</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">AI-powered financial research engine. 500K+ filings indexed, real-time market analysis.</p>
              <span className="px-2 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 text-xs rounded">Python</span>
            </a>

            <a href="https://github.com/houssem98/TradingAgents" target="_blank" rel="noopener noreferrer" className="group p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg hover:border-blue-400 transition">
              <h3 className="text-xl font-semibold mb-2 group-hover:text-blue-600">Trading Agents</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">Autonomous agents for market analysis and trade execution. Multi-model coordination.</p>
              <span className="px-2 py-1 bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200 text-xs rounded">Python</span>
            </a>

            <a href="https://github.com/houssem98/hermes-audit" target="_blank" rel="noopener noreferrer" className="group p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg hover:border-blue-400 transition">
              <h3 className="text-xl font-semibold mb-2 group-hover:text-blue-600">Hermes Daemon</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">Self-hosted trading research daemon. Real-time alerts, dividend tracking, briefings.</p>
            ...
            <a href="https://github.com/houssem98/trustgrid-dashboard" target="_blank" rel="noopener noreferrer" className="group p-6 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-lg hover:border-blue-400 transition">
              <h3 className="text-xl font-semibold mb-2 group-hover:text-blue-600">TrustGrid</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">On-chain data verification dashboard. Grid trust scoring, source validation.</p>
      ...
      <section className="py-20 px-6 bg-blue-600 dark:bg-blue-900 text-white">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mb-8 text-lg opacity-90">Join the research. Follow on GitHub, or reach out to discuss partnerships.</p>
          <div className="flex gap-4 justify-center">
